...
TEST(selector_parse) {
  ...
  const Row rows[] = {
    ...
    {"512:15:512:101:0", "512:15:512:101:0", 4},
    {"ll:512:15:512", "ll:512:15:512", 7},
    {"prp:1", "prp:1", 6},
    {"ll:1:1K:8:256:202:1", "ll:1:1K:8:256:202:1", 9},
  };
...
TEST(selector_matches) {
  ...
  const Row rows[] = {
    ...
    {"512:15:512:101:0", "512:15:512:101:0", TestKind::PRP, true},
    {"512:15:512:101:0", "512:15:512:101", TestKind::PRP, false},
    {"512:15:512:101:1", "512:15:512:101:0", TestKind::PRP, false},
    {"512:15:512:101:1", "512:15:512:101", TestKind::PRP, false},
    {"512:15:512:101:0", "512:15:512:101:1", TestKind::PRP, false},
    {"1:512:8:512:202:0", "1:512:8:512:202", TestKind::PRP, false},
...
TEST(precedence) {
  ...
  std::vector<Row> const rows = {
    ...
    {"carry selector needs that carry",
     {"! 512:15:512:101 X=variant", "! 512:15:512:101:0 X=carry"},
     "",
     {},
     "512:15:512:101",
     TestKind::PRP,
     "variant"},
    {"carry beats variant",
     {"! 512:15:512:101:0 X=carry", "! 512:15:512:101 X=variant"},
     "",
     {},
     "512:15:512:101:0",
     TestKind::PRP,
    ...
    {"kind alone beats unqualified carry",
     {"! prp X=kind", "! 512:15:512:101:0 X=carry"},
     "",
     {},
     "512:15:512:101:0",
     TestKind::PRP,
    ...
    {"command line beats every ! line",
     {"! prp:512:15:512:101:0 X=best", "-use X=config"},
     "-use X=cli",
     {},
     "512:15:512:101:0",
     TestKind::PRP,
