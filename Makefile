...
TESTSRCS = test_main.cpp test_Gpu.cpp test_OptionSpace.cpp test_UseResolve.cpp test_FFTVariants.cpp test_Eligibility.cpp test_TuneDB.cpp test_Selection.cpp
